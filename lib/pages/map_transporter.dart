...
import 'package:agroschoolbus/utils/marker_controller_transporter.dart';

import 'dart:math';
// 729D37

class MapPageTransporter extends StatefulWidget {
  const MapPageTransporter({super.key, required this.title});

  final String title;

  @override
  State<MapPageTransporter> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<MapPageTransporter> {

  late MarkerControllerTransporter markerController;
  ...
  void initState() {
    ...
    osrm_api = OsrmApi();
    markerController = MarkerControllerTransporter(onMarkersUpdated: () {
      setState(() {});
  ...
  void getTruckCapacity() {
    ...
    ui_ctrl.showInputDialogTransporter(obj);
